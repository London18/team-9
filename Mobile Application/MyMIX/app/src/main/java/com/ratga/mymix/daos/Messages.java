...
interface MessageService
{
	...
	@GET("Messages.php?cmd=getMessagesBySessionId")
	Call<List<Message>> getMessagesBySessionId(@Query("sessionId")Integer  sessionId);
...
public class Messages
{
	...
	public static List<Message> getMessagesBySessionId(Integer  sessionId)
	{
		List<Message> messages;
		MessageService service;
		Call<List<Message>> call;
		...
		try
		{
			call = service.getMessagesBySessionId(sessionId);
			messages = getMessages(call);
		}
		catch(Exception ee)
		{
	...
	public static void getMessagesBySessionId(Integer  sessionId, Callback<List<Message>> callback)
	{
		List<Message> messages;
		MessageService service;
		Call<List<Message>> call;
